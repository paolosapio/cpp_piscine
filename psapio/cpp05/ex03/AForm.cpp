...
AForm::AForm() : _name("DefaultForm"), _gradeToSign(150), _gradeToExec(150), _isSigned(false)
{
}
...
AForm::AForm(const AForm &other) : _name(other._name), _gradeToSign(other._gradeToSign), _gradeToExec(other._gradeToExec), _isSigned(other._isSigned)
{
}
